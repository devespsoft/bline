...
export default class accountsetting extends Component {
  ...
  async approveNFT(itemDetails) {
    var tokenID = itemDetails.token_id;
    let fromAddress = this.state.aboutData?.address;
    let to_address = "0xb1b3b9104c0ee3fc67626b50374509ad11ded0fd";
  ...
  async putOnSaleAPI(item) {
    ...
    var approveNFTRes = await this.approveNFT(item);
    if (approveNFTRes) {
      $("#nft" + item.item_id).css({ "display": "none" });
      const token = this.token
      await axios({
        ...
        data: {
          ...
          "start_date": this.state.nftData?.start_date1,
          "expiry_date": this.state.nftData?.expiry_date1
        }
      }).then((res) => {
        if (res.data.success === true) {
          this.modalShow(0)
                  ...
                  <div className="col-sm-9 col-xs-12">
                    <div className="tab-content create-collection" id="v-pills-tabContent">
                                ...
                                <div className="tab-1" style={{ display: this.state.nftType === 1 ? 'block' : 'none' }}>
                                  <div className="row">
                                    {this.state.myNftData.length > 0 ?
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                          <div class="nft__item">
                                            ...
                                            {this.loginData?.id == item.owner_id ?
                                              <div class="three-dots-drop ">
                                                <a onClick={this.openDot.bind(this, this.state.openDotDrop, item.item_id)} href="javascript:void(0)" class="dot-btn"> <i class="fa fa-ellipsis-v" aria-hidden="true"></i></a>
                                                <ul className="dots-dropdown" id={`nft${item.item_id}`} >
                                                  ...
                                                  {item.is_on_sale == 1 ?
                                                    ...
                                                    ""
                                                    :
                                                    <a onClick={this.putOnSaleModelAPI.bind(this, item)} className='sale-list' data-toggle="modal" data-target="#putOnSale" href="javascript:void(0)"> <li>Put on sale</li> </a>
                                                  }
                                                  <li></li>
                                              ...
                                              : ""}
                                            <div class="nft__item_wrap mycollection_nft">
                                            ...
                                            <a href={`${config.baseUrl}nftDetails/` + item.item_id}>
                                              <div class="nft__item_info">
                                                <h4>{`${item.name.substring(0, MAX_LENGTH)}..`}
                                                  <small class="pull-right">{item.is_on_sale == 0 ? "" : "Price"}</small></h4>
                                                <div class="nft__item_price">
                                                  <div className="row">
                                                    ...
                                                    <div className="col-sm-7 priceAda">
                                                      <div class="d-flex pull-right"><span>
                                                        {item.is_on_sale == 0 ?
                                      ...
                                      : <h6 style={{ textAlign: 'center' }}>No Collection Found!!! </h6>
                                    }
                                  </div>
                                </div>
                                      ...
                                      this.state.myNftData.map(item => (
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                          <div class="nft__item">
                                            ...
                                            <Link to={`${config.baseUrl}nftDetails/` + item.item_id}>
                                              <div class="nft__item_info">
                                                <h4>{`${item.name.substring(0, MAX_LENGTH)}..`}<small class="pull-right">{item.is_on_sale == 0 ? "" : "Price"}</small></h4>
                                                <div class="nft__item_price">
                                                  <div className="row">
                                                    <div className="col-sm-5 portfolio-name">
                                                      {item.collection_name ?
                                                ...
                                                <div class="nft__item_info">
                                                  ...
                                                  {item.name ?
                                                    item.name.length > MAX_LENGTH ?
                                                      ...
                                                      <h4>{item.name} <small class="pull-right">{item.is_on_sale == 0 ? "" : "Price"}</small></h4>
                                                    : ""}

                                                  {/* <h4>{item.name}<small class="pull-right">Price</small></h4> */}
                                                  <div class="nft__item_price">
                                                    <div className="row">
                                                      <div className="col-sm-5 portfolio-name">
                                                        {item.collection_name ?
                      ...
                      <div className={this.state.selectedTab == '6' ? "tab-pane fade show active" : "tab-pane fade"} id="Collections" role="tabpanel" aria-labelledby="Collections-tab">
                        <div className="info-block style-1">
                          <div className="be-large-post-align ">
                            <h3 className="info-block-label d-inline">Collections</h3>
                            <Link to={`${config.baseUrl}createcollection`}>
                              <h3 className="info-block-label pull-right"><i class="fa fa-plus" aria-hidden="true"></i></h3>
                            </Link>
                          </div>
                        </div>
                        ...
                        <>
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              <h5>Starting date</h5>
                              <input type="date" value={this.state.nftData?.start_date1} onChange={this.handleChange} name="start_date" min={this.state.currentDate} id="bid_starting_date" className="form-control" />
                            </div>
                            <div className="col-md-6">
                              <h5>Expiration date</h5>
                              <input type="date" min={this.state.endDate} value={this.state.nftData?.expiry_date1} onChange={this.handleChange} name="expiry_date" id="bid_expiration_date" className="form-control" />
                            </div>
                            <div className="spacer-single" />
                          </div>
                        </>
