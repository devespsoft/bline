...
export default class createnft extends Component {
  ...
  async createNftAPI(mintRes) {
    ...
    this.setState({
      imageData:mintRes.ImageFileHash
    })
      ...
      <>
        ...
        >
          <div className="text-center pl-3 pr-3">
            ...
            <br />
            <h4 style={{ color: '#3fa1f3', fontSize: '16px' }}>NFT minting in progress, once process completed NFT will be display on your portfolio page.</h4>
                ...
                <div className="col-lg-8">
                  <form id="form-create-item" className="form-border" method="post" action="email.php">
                    <div className="field-set">
                      <h2>Creat a new item</h2>
                      <p><span style={{ color: "red" }}>*</span>Required fields</p>
                      <h5>Image, Video, Audio, or 3D Model</h5>
                      <p id="file_name">File types supported:PNG, JPG, GIF, WEBP or MP4</p>
                        ...
                        <div className="d-create-file">
                          {this.state.file_type == 'image' ?
                            this.state.image_preview === '' ?
                              ""
                              :
                              <img style={{ height: '192px', width: '100%' }} id="image" className="object-cover w-full h-32 w-100" src={this.state.image_preview} />

                            :
                            this.state.file_type == 'video' ?
                              <a target="_blank" href={this.state.image_preview}>
                                <img style={{ height: '192px', width: '100%' }} id="image" className="object-cover w-full h-32 w-100" src="images/video-icon.png" />
                              </a>
                      ...
                      <h5>Title</h5>
                      <input type="text" name="name" onChange={this.handleChange} id="item_title" className="form-control" placeholder="e.g. 'Crypto Funk" maxLength="150" />
                      ...
                      <textarea data-autoresize name="description" onChange={this.handleChange} id="item_desc" className="form-control" placeholder="e.g. 'This is very limited item'" maxLength="250" />
                      <span className="error-asterick"> {this.state.descError}</span>
                      <div className="spacer-10" />
                      <div className="collection-drop">
                        <h5>Collection &nbsp;
                        </h5>
                        <p style={{ color: "rgb(110 119 128)" }}>This is the collection where your item will appear
                          <button type='button' onClick={this.openModel.bind(this)} className='btn btn-sm btn-primary pull-right add-plus' >
